...
def main_rnn():
    ...
    writer = SummaryWriter(log_dir="runs/PPO_RNN_Experiment") # Use a new log directory
    ...
    ppo_agent = PPO_RNN(
        ...
        rnn_hidden_size, rnn_n_layers  # Pass RNN-specific parameters
    )
    memory = MemoryRNN()
    ...
    for episode in range(config.N_EPISODES):
        ...
        for t in range(config.MAX_TIMESTEPS):
            ...
            if crashed: reward = -7000; done = True
