# src/models.py
# Contains the definition of the Actor-Critic neural network model.
...
class ActorCritic(nn.Module):
    def __init__(self, state_vec_dim, action_dim, action_std_init=0.1): #action_std_init was changes to =0.1
        ...
        # --- MLP Branch for Vector Input (Camera Position) ---
