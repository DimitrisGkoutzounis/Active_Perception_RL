...
DIST_MIN = 55 # Minimum allowed distance to ROI center for the agent
...
NUM_OBSTACLES = 3
OBSTACLE_MIN_DIST_FROM_ROI = 15
OBSTACLE_MAX_DIST_FROM_ROI = 40
OBSTACLE_MIN_RADIUS = 2.0
OBSTACLE_MAX_RADIUS = 5.0

# Agent starting position generation parameters
AGENT_MIN_START_DIST_FROM_ROI = 50
AGENT_MAX_START_DIST_FROM_ROI = 100
...
EVAL_MAP_BOUNDS = [-100, 100, -100, 100]